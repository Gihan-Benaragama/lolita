...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="h-full">
    <head>
        ...
        <title>{{ config('app.name', 'Lolita') }} — {{ $title ?? 'Welcome' }}</title>

        <!-- Fonts: Cormorant Garamond (display) + Jost (sans) — same as app layout -->
    ...
    <body class="h-full bg-ivory text-ink font-sans antialiased">
